        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content" style="">
                    <form method="post" id="category-add" class="form-horizontal" action="<?= \yii\helpers\Url::to(['category/add'])?>">
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">分类描述</label>
                            ...
                            <div class="col-sm-10"><input type="text" id="cate_desc" name="cate_desc" class="form-control"></div>
                        </div>
                        <div class="hr-line-dashed"></div>
